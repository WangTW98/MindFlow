...
import { escapeHtml, getNonce } from "../canvas/flowWebviewHtml";
...
export function renderSidebarHtml(options: SidebarHtmlOptions): string {
  ...
  const style = options.webview.asWebviewUri(vscode.Uri.joinPath(options.extensionUri, "src", "webview", "media", "sidebar.css"));
  return `<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="UTF-8">
