...
import { FlowEditorRegistry, type OpenFlowEditorSession } from "../FlowEditorRegistry";
import { FlowSelectionStore } from "../FlowSelectionStore";
import type { ProductFlow } from "../../../../domain/product-flow";
import { FlowEditorSession } from "./FlowEditorSession";
import type { FlowSelectionPatch, FlowSelectionState } from "../../../../domain/product-flow/selection";
...
export class FlowPanel implements vscode.CustomTextEditorProvider {
  ...
  public resolveCustomTextEditor(
    ...
    webviewPanel.webview.options = {
      enableScripts: true,
      localResourceRoots: [vscode.Uri.joinPath(this.extensionUri, "src", "adapters", "webview", "canvas", "media")]
    };
