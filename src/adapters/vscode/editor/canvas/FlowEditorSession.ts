...
import { parseProductFlowText, serializeProductFlow, tryParseProductFlowText } from "../../../../domain/product-flow/serialization/codec";
...
export class FlowEditorSession {
  ...
  private mediaUri(fileName: string): string {
    return this.panel.webview.asWebviewUri(vscode.Uri.joinPath(this.extensionUri, "src", "adapters", "webview", "canvas", "media", ...fileName.split("/"))).toString();
  }
}
