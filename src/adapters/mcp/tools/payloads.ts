import { normalizeFlowSelection, type FlowSelectionPatch } from "../../../domain/product-flow/selection";
import type { FlowOperationResult } from "../../../application/flow-operations";
import { PROJECT_OVERVIEW_NODE_ID } from "../../../application/flow-operations";
